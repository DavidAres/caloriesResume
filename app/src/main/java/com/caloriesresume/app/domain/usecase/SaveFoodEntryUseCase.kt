...
class SaveFoodEntryUseCase @Inject constructor(
    ...
    suspend operator fun invoke(imageUri: Uri, nutritionInfo: NutritionInfo, logMealResponse: com.caloriesresume.app.domain.model.LogMealResponse?): Long {
        return repository.saveFoodEntry(imageUri, nutritionInfo, logMealResponse)
    }
}
